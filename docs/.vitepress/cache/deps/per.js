...
// node_modules/per/per.js
var require_per = __commonJS({
  "node_modules/per/per.js"(exports, module) {
    (function(exportFunction) {
      function toFunc(valOrFunc, bindThis) {
        if (typeof valOrFunc !== "function") {
          return Array.isArray(valOrFunc) ? function(emit) {
      ...
      function lambda(expression) {
        return typeof expression === "string" ? new Function("x", "return " + expression) : expression;
      }
      ...
      Per.prototype.flatten = function() {
        return this.per(function(emit, array) {
          return !Array.isArray(array) ? emit(array) : array.some(function(value) {
            return emit(value);
          });
        });
      };
      ...
      Per.prototype.multicast = function(destinations) {
        ...
        destinations = destinations.map(function(destination) {
          return typeof destination === "function" ? destination : destination instanceof Per ? destination.forEach : ignore;
        });
      ...
      Per.prototype.monitor = function(data) {
        var n = 0;
        var count = setOrCall(data, "count"), first = setOrCall(data, "first"), last = setOrCall(data, "last"), limit = data.limit;
      ...
      Per.prototype.min = function() {
        return this.reduce(min, Number.MAX_VALUE);
      };
      function max(l, r) {
        return Math.max(l, r);
      }
      Per.prototype.max = function() {
        return this.reduce(max, Number.MIN_VALUE);
      };
      function sum(l, r) {
        return l + r;
      }
      ...
      Per.prototype.and = function() {
        return this.reduce(and, true);
      };
      function or(l, r) {
        return !!(l || r);
      }
      Per.prototype.or = function() {
        return this.reduce(or, false);
      };
      function not(v) {
        return !v;
      }
      Per.prototype.not = function() {
        return this.map(not);
      };
...
export default require_per();
//# sourceMappingURL=per.js.map
